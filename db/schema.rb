...
ActiveRecord::Schema[8.0].define(version: 2026_04_14_121500) do
  ...
  add_foreign_key "user_follow_requests", "users", column: "requested_user_id"
  add_foreign_key "user_follow_requests", "users", column: "requesting_user_id"
end
